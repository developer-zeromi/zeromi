...
<!--   <div class="page-header section-dark" style="background-image: url('./resources/assets/img/antoine-barres.jpg')"> -->
  <div class="page-header section-dark" style="background-image: url('./resources/assets/img/main_programming_2.jpg')">  
   <div class="filter"></div>
    <div class="content-center">
      <div class="container">
        <div class="title-brand">
          <h1 class="presentation-title">DEVELOPER ZEROMI</h1>
          <div class="fog-low">
        ...
        <h2 class="presentation-subtitle text-center">2020 First Project</h2>
      </div>
    </div>
